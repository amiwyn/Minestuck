...
public class MinestuckConfig
{
	...
	public static class Server
	{
		...
		public final BooleanValue kernelSpriteSpawns;
		...
		private Server(Builder builder)
		{
			...
			kernelSpriteSpawns = builder.comment("If this is true, a kernelsprite will generate when the cruxtruder lid is first broken for a player")
					.define("kernelSpriteSpawns", true);
