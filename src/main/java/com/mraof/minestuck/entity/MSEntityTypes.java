...
public final class MSEntityTypes
{
	...
	public static final EntityType<KernelspriteEntity> KERNELSPRITE = getNull();
	...
	public static void registerEntities(final RegistryEvent.Register<EntityType<?>> event)
	{
		...
		register(registry, EntityType.Builder.<KernelspriteEntity>create(KernelspriteEntity::new, EntityClassification.CREATURE).size(0.85F, 0.85F), "kernelsprite");
	}
